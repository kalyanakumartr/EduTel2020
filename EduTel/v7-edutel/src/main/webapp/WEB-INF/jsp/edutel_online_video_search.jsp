				...
				<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
					...
					<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
						...
						<ul class="menu-nav">
							...
							<li class="menu-item" aria-haspopup="true"><a href="${pageContext.request.contextPath}${preSearchVideoURL}" class="menu-link"> <span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:${pageContext.request.contextPath}/assets/media/svg/icons/Design/Layers.svg--> <svg xmlns="http://www.w3.org/2000/svg"
					...
					<div class="topbar">
						...
						<div class="topbar-item">
							...
							<div class="alert-text">
								This Panel is used to search EduTel Tutor Videos. <br />Administrator / Employee user can search the videos online to update or block or delete.
							</div>
						</div>
						<!--end::User-->
					</div>
								...
								<div class="card card-custom card-stretch">
									<div class="card-header">
										...
										<div class="card-toolbar">
											<!--begin::Button-->
											<a href="javascript:addVideo();" class="btn btn-primary font-weight-bolder"> <span class="svg-icon svg-icon-md"> <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<rect x="0" y="0" width="24" height="24" />
