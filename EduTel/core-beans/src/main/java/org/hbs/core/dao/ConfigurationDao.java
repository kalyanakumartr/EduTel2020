...
public interface ConfigurationDao extends CrudRepository<ProducersProperty, String>
{
	...
	List<ProducersProperty> getConfigurationByType(@Param("producerId") String producerId, @Param("media") EMedia media, @Param("mediaType") EMediaType mediaType,
			@Param("mediaMode") EMediaMode mediaMode);
